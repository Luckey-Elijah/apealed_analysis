...
- [`strict-casts: true`](https://dart.dev/guides/language/analysis-options#enabling-additional-type-checks)
- [`strict-inference: true`](https://dart.dev/guides/language/analysis-options#enabling-additional-type-checks)
- [`strict-raw-types: true`](https://dart.dev/guides/language/analysis-options#enabling-additional-type-checks)

### [Severity Updates (`errors`)](https://dart.dev/guides/language/analysis-options#changing-the-severity-of-rules):

- `missing_required_param` as `error`
- `missing_return` as `error`

### [Excluded Paths (`exclude`)](https://dart.dev/guides/language/analysis-options#excluding-code-from-analysis)

- `test/.test_coverage.dart` generated by [`coverage`](https://pub.dev/packages/coverage)
- `lib/generated_plugin_registrant.dart` generated by [Flutter web-compiled projects](https://stackoverflow.com/a/65357096/9727402)
- `"**/*.freezed.dart"` generated by [`freezed`](https://pub.dev/packages/freezed)
- `"**/*.g.dart"` generated by many code-generating projects, including [`json_serializable`](https://pub.dev/packages/json_serializable)
- `"**/__brick__/*"` used in [`mason`](https://pub.dev/packages/mason_cli) projects

### Linter Rules:
<details>
<summary> Included Rules </summary>
...
- [`avoid_web_libraries_in_flutter`](https://dart-lang.github.io/linter/lints/avoid_web_libraries_in_flutter.html)
